        ...
        <div className="grid grid-cols-3 gap-x-20 gap-y-16 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="size-25 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center mb-2 shadow-lg group-hover:shadow-2xl transition-all duration-300 group-hover:from-blue-600 group-hover:to-blue-700 overflow-hidden p-8">
                <Lottie
              ...
              {/* Feature Name */}
              <p className="font-bold text-lg text-gray-800 group-hover:text-blue-600 transition-colors duration-300">
                {feature.name}
              </p>
            </div>
          ))}
